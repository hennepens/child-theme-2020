...
"<ul class='purchase-options'>\n".
	...
	($subscription_options ? "<li". (isset($selected_subscription_option) ? " class='selected'" : "") .">".
		...
		"<div class='delivery-container'><h6 class='prompt-heading'>Choose a Subscription Cycle</h6><div class='subscription-delivery'><label class='delivery-every'>Please deliver <span class='current_selected_qty'></span> <span class='current_selected_variant'></span> every</label><select name='subscription-options'>". implode('', $subscription_options) ."</select>\n" : "").
