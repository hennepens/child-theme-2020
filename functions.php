...
function bbloomer_referral_link_content() {
   ...
   echo '<div class="text-center"><label><b>Your Unique Share Link:</b></label> <a class="coupon-code-link" href="'. site_url() . '/shop/?coupon_code=' . do_shortcode( '[automatewoo_advocate_referral_coupon]' ) .'"><u>' . site_url() . '/shop/?coupon_code=' . do_shortcode( '[automatewoo_advocate_referral_coupon]' ) . '</u></a></div>';
